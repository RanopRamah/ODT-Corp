            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 style="color: black;" class="h3 mb-0 font-weight-bolder ff-sfBold">Pendapatan</h1>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 style="font-weight: bolder;" class="m-0 font-weight-bold ff-sfBold text-primary">Pendapatan</h6>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <a class="dropdown-item text-primary" href="#">Pendapatan</a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 font-weight-bolder text-primary mb-2 ff-sfBold">
                                                Pendapatan</div>
                                            <div style="color: black;" class="h4 mb-0 font-weight-bold ff-sfBold">Rp <?php echo number_format((float)$pdp, 0,",") ?></div>
                                        </div>
                                        <div class="col-auto">
