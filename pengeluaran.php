        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <a class="dropdown-item text-primary" href="pendapatan.html">Pendapatan</a>
                                            <a class="dropdown-item text-success" href="#">Pengeluaran</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="keuangan.html">Tampilkan keduanya</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Card Body -->
                    ...
                    <button class="btn btn-primary shadow mb-4"><a href="index.php" class="text-white" style="text-decoration: none; font-weight: 600;">Kembali</a></button>
                </div>
                <!-- /.container-fluid -->
