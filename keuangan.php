    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">ODT Corps</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 font-weight-bolder text-primary mb-2">
                                                Pendapatan</div>
                                            <div class="h4 mb-0 font-weight-bold text-gray-800">Rp <?php echo number_format((float)$pdp, 0,",") ?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-6 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class=" h5 font-weight-bolder text-success mb-2">
                                                Pengeluaran</div>
                                            <div class="h4 mb-0 font-weight-bold text-gray-800">Rp <?php echo number_format((float)$pgl, 0,",") ?></div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-success">Pengeluaran</h6>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <a class="dropdown-item" href="pendapatan.html">Pendapatan</a>
                                            <a class="dropdown-item" href="pengeluaran.html">Pengeluaran</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="#">Tampilkan keduanya</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Card Body -->
                    ...
                    <button class="btn btn-primary shadow mb-4"><a href="index.php" class="text-white"
                                    style="text-decoration: none; font-weight: 600;">Kembali</a></button>
                </div>
                <!-- /.container-fluid -->
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [<?php echo $pdp_jan['total_jan']?>, <?php echo $pdp_feb['total_feb']?>, <?php echo $pdp_mar['total_mar']?>, <?php echo $pdp_apr['total_apr']?>, <?php echo $pdp_mei['total_mei']?>, <?php echo $pdp_jun['total_jun']?>, <?php echo $pdp_jul['total_jul']?>, <?php echo $pdp_agu['total_agu']?>, <?php echo $pdp_sep['total_sep']?>, <?php echo $pdp_okt['total_okt']?>, <?php echo $pdp_nov['total_nov']?>,<?php echo $pdp_des['total_des']?>],
    }],
  },
  options: {
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [<?php echo $pgl_jan['total_jan']?>, <?php echo $pgl_feb['total_feb']?>, <?php echo $pgl_mar['total_mar']?>, <?php echo $pgl_apr['total_apr']?>, <?php echo $pgl_mei['total_mei']?>, <?php echo $pgl_jun['total_jun']?>, <?php echo $pgl_jul['total_jul']?>, <?php echo $pgl_agu['total_agu']?>, <?php echo $pgl_sep['total_sep']?>, <?php echo $pgl_okt['total_okt']?>, <?php echo $pgl_nov['total_nov']?>,<?php echo $pgl_des['total_des']?>],
    }],
  },
  options: {
    maintainAspectRatio: false,
